...
module.exports = {
  ...
  getComponentPathLine(componentPath) {
    ...
    return `import { ${name} } from 'date-range-picker';`;
  },
  ...
  moduleAliases: {
    'date-range-picker/dist': path.resolve(__dirname, moduleSource),
    'date-range-picker': path.resolve(__dirname, moduleSource),
  },
  webpackConfig: {
    module: {
      rules: [
